...
public class PayService extends Service{
    ...
    String url = urlBase+"/payTransService";
    ...
    public PayService(String type, String subType, String code, String ki, String encryptedBase64String, String transactionId){
        this.type = type;
    ...
    public Response execute() {
        ...
        PayTransServiceResponse payTransServiceResponse =
                gson.fromJson(json.toString(), PayTransServiceResponse.class);

        return payTransServiceResponse;
